      ...
      <div className="addStoryBox">
        ...
        <div id="imgWorkFlex">
         ...
         {isShown && (
          ...
          <input name="jobName" type="text" placeholder="Indtast erhverv..." id="workName" value={formData.jobName} onChange={(e) => handleChange(e)}/>
          <div className="jobIcons">
              <li>
                <input type="checkbox" name="jobIcon" id="jobIconbox1" value={"book"} onChange={(e) => handleChange(e)}/>
                <label htmlFor="jobIconbox1">
                  <img src={book} alt="Bog"/>
                </label>
              </li>

              <li><input type="checkbox" name="jobIcon" id="jobIconbox2" value={"briefcase"} onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox2"><img src={briefcase} alt="Taske"/></label></li>
              <li><input type="checkbox" name="jobIcon" id="jobIconbox3" value={"penge"} onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox3"><img src={dollar} alt="Penge"/></label></li>
              <li><input type="checkbox" name="jobIcon" id="jobIconbox4" value={"hammer"} onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox4"><img src={hammer} alt="Hammer"/></label></li>
              <li><input type="checkbox" name="jobIcon" id="jobIconbox5" value={"blade"} onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox5"><img src={leaf} alt="Blade"/></label></li>
              <li><input type="checkbox" name="jobIcon" id="jobIconbox6" value={"lineal"} onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox6"><img src={ruler} alt="lineal"/></label></li>
              <li><input type="checkbox" name="jobIcon" id="jobIconbox7" value={""} onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox7"><img src={saw} alt="Sav"/></label></li>
              <li><input type="checkbox" name="jobIcon" id="jobIconbox8" value={"suit"} onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox8"><img src={suit} alt="Jakkesæt"/></label></li>
              <li><input type="checkbox" name="jobIcon" id="jobIconbox9" value={"node"} onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox9"><img src={node} alt="Node"/></label></li>
              <li><input type="checkbox" name="jobIcon" id="jobIconbox10" value={"blyant"}  onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox10"><img src={pencil} alt="Blyant"/></label></li>
              <li><input type="checkbox" name="jobIcon" id="jobIconbox11" value={"non"}  onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox11"><img src={noIcon} alt="Intet valg"/></label></li>
          </div>
      </div>
        )}
        ...
        <div className="submitHistoryBtn">
          ...
          <AddedModal title="Post livshistorie?" onClose={closeModal} show={show}>
            <button className="btn formsubmit" onClick={() => {
              handlePublish();
              closeModal();
              }}>
            <svg width="30" height="30" viewBox="0 0 392 392" fill="none" xmlns="http://www.w3.org/2000/svg">
