        ...
        <div id="imgWorkFlex">
         ...
         {isShown && (
          ...
          <div className="jobIcons">
              ...
              <li><input type="radio" name="jobIcon" id="jobIconbox3" value={"penge"} onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox3"><img src={dollar} alt="Penge"/></label></li>
              ...
              <li><input type="radio" name="jobIcon" id="jobIconbox5" value={"blade"} onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox5"><img src={leaf} alt="Blade"/></label></li>
              <li><input type="radio" name="jobIcon" id="jobIconbox6" value={"lineal"} onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox6"><img src={ruler} alt="lineal"/></label></li>
              <li><input type="radio" name="jobIcon" id="jobIconbox7" value={""} onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox7"><img src={saw} alt="Sav"/></label></li>
              ...
              <li><input type="radio" name="jobIcon" id="jobIconbox9" value={"node"} onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox9"><img src={node} alt="Node"/></label></li>
              <li><input type="radio" name="jobIcon" id="jobIconbox10" value={"blyant"}  onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox10"><img src={pencil} alt="Blyant"/></label></li>
              <li><input type="radio" name="jobIcon" id="jobIconbox11" value={"non"}  onChange={(e) => handleChange(e)}/><label htmlFor="jobIconbox11"><img src={noIcon} alt="Intet valg"/></label></li>
          </div>
      </div>
        )}
